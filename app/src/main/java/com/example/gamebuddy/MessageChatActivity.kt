    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        reference!!.addValueEventListener(object: ValueEventListener{
            override fun onDataChange(p0: DataSnapshot)
            {
                ...
                Picasso.get().load(user.getProfile()).placeholder(R.drawable.profile).into(profile_image_mchat)
        ...
        send_message_btn.setOnClickListener{
            ...
            if(message =="")
            {
                Toast.makeText(this@MessageChatActivity, "Mesaj yazınız " , Toast.LENGTH_LONG).show()
            }
            else
            {
                    ...
                    apiService!!.sendNotification(sender).enqueue(object : Callback<MyResponse>
                    {
                        ...
                        )
                        {
                            if(response.code() == 200)
                            {
                                ...
                                {
                                    Toast.makeText(this@MessageChatActivity, "Başarısız.", Toast.LENGTH_LONG).show()
                                }
                            }
                        }
        ...
        if(requestCode == 438 && resultCode ==RESULT_OK &&data!=null && data!!.data!=null)
        {
            ...
            uploadTask.continueWithTask(Continuation <UploadTask.TaskSnapshot, Task<Uri>>{ task ->
                ...
                if(task.isSuccessful){
                    ...
                    messageHashMap["message"] = "Fotoğraf Gönderdi."
                            ...
                            if (task.isSuccessful)
                            {
                                ...
                                reference.addValueEventListener(object : ValueEventListener
                                {
                                    override fun onDataChange(p0: DataSnapshot) {
                                        ...
                                        if(notify)
                                        {
                                            sendNotification(userIdVisit, user!!.getUserName(),"Fotoğraf Gönderdi.")
                                        }
                                        notify = false
                                    }
